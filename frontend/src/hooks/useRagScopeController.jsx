...
/**
 * Coordinates the RAGScope client workflow: dataset loading, retrieval experiments,
 * audit generation, saved views, and the chart/table/inspector interaction model.
 */
export function useRagScopeController() {
  ...
  return {
    ...
    setAuditQueries,
    llmAuditSettings,
    updateLlmAuditSetting,
    queryGenerationLoading,
    llmModelNames,
    llmModelDetails,
    llmModelsLoading,
    viewName,
    ...
    handleRetrievalExperiment,
    compareRetrievalModes,
    saveRetrievalRun,
    loadRetrievalRun,
    exportRetrievalReport,
